...
<header>
  <div class="container">
    <div class="row">
      <div class="span6">
        <div class="logo">
          <h1><a href="#">Software <span class="color">Engineering</span></a></h1>
      ...
      <div class="span6">
        <div class="form">
          <form method="get" id="searchform" action="#" class="form-search" />
            ...
            <a href="login.html"><button id="mainlogin" type="button"  class="btn">登录</button></a>
                 ...
                 <ul class="nav">
                   ...
                   <!-- Refer Bootstrap navbar doc -->
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="alterpassword.jsp">密码修改</a></li>
                   ...
                   <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="service-3.html">精华内容</a></li>
                   ...
                   <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="studynote.jsp">课程笔记</a></li>
                        <li><a href="filedownload.jsp">资料下载</a></li>
                      </ul>
                   </li>
